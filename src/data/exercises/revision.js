...
7. 30.10 : Amortissement mensuel mobilier CHF 500 (méthode directe)`,
    ...
    ecritures: [
      ...
      { id: 'e5', libelle: '10.10 — Paiement loyer', debit: { num: '6100', label: 'Loyer' }, credit: { num: '1020', label: 'Banque' }, amount: 2200 },
      ...
      { id: 'e10', libelle: '30.10 — Amortissement mobilier', debit: { num: '6800', label: 'Amortissements' }, credit: { num: '1500', label: 'Mobilier' }, amount: 500 },
    ],
  },
...
9. Provision impôts CHF 1'500`,
    ...
    ecritures: [
      ...
      { id: 'e8', libelle: 'Amortissement mobilier', debit: { num: '6800', label: 'Amortissements' }, credit: { num: '1500', label: 'Mobilier' }, amount: 2000 },
      { id: 'e9', libelle: 'Provision impôts', debit: { num: '8900', label: 'Charge d\'impôts' }, credit: { num: '2300', label: 'Provision impôts' }, amount: 1500 },
    ],
  },
...
8. 30.11 : Loyer payé d'avance CHF 2'500 (actif transitoire)`,
    ...
    ecritures: [
      ...
      { id: 'e10', libelle: '30.11 — Amortissement véhicule (indirect)', debit: { num: '6830', label: 'Amort. véhicules' }, credit: { num: '1539', label: 'Ajust. valeur véhicules' }, amount: 800 },
      { id: 'e11', libelle: '30.11 — Loyer payé d\'avance', debit: { num: '1300', label: 'Charges payées d\'avance' }, credit: { num: '6100', label: 'Loyer' }, amount: 2500 },
    ],
  },
];
