...
import { P, H2, H3, Note, Tableau, Ecriture, GrilleT, TheoryLayout } from './TheoryUI';
...
function TabIntro() {
  return (
    <div>
      ...
      <H2>3. La comptabilité ≠ la caisse</H2>
      ...
      <H2>4. La partie double — comment ça fonctionne</H2>
      ...
      <H2>5. Les états financiers — vue d'ensemble</H2>
      <Tableau
...
function TabBilan() {
  return (
    <div>
      <H2>1. Qu'est-ce que le bilan ?</H2>
      ...
      <H2>2. L'actif — ce que l'entreprise possède</H2>
      ...
      <H2>3. Le passif — comment c'est financé</H2>
...
function TabResultat() {
  return (
    <div>
      <H2>1. Qu'est-ce que le compte de résultat ?</H2>
      ...
      <H2>2. Les produits — ce que l'entreprise gagne</H2>
      ...
      <H2>3. Les charges — ce que l'entreprise consomme</H2>
      ...
      <H2>5. Charge ≠ Paiement | Produit ≠ Encaissement</H2>
...
function TabComptes() {
  return (
    <div>
      <H2>1. Qu'est-ce qu'un compte ?</H2>
      ...
      <H2>2. La représentation en T</H2>
      ...
      <H2>3. La règle de fonctionnement selon la nature du compte</H2>
      ...
      <H2>4. Comptes du bilan vs comptes du résultat</H2>
      <Tableau
      ...
      <H2>5. Le plan comptable PME suisse</H2>
...
function TabJournal() {
  return (
    <div>
      <H2>1. Le journal — registre de toutes les opérations</H2>
      ...
      <H2>2. La méthode des postes ouverts — factures d'abord, paiements ensuite</H2>
      ...
      <H2>3. Les 4 opérations courantes — écritures complètes</H2>
      ...
      <H2>4. Autres opérations fréquentes</H2>
      ...
      <H2>5. La pièce justificative — obligation légale</H2>
